...
// ════════════════════════════════════════════════════════════════════════
// 界狂骨(界魏延·被动可选技):对距离1以内的角色造成伤害时,可以回复1点体力或摸一张牌。
//   与狂骨同构:两步询问(是否发动 → 二选一),可选触发(2026-08-15 由锁定技改为可选)。
