...
import { executePlan } from '@engine/v2/phase';
import { registerCharacterTriggers, emitEvent, registerSkill, getSkillRegistry } from '@engine/v2/skill';
import type { SkillContext, GameState, SkillPhase, PendingAction } from '@engine/v2/types';
import {
  getCharacterMap,
  createTestGame,
  setHealth,
