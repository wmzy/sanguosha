...
/** 粘性展示事件类型:火攻/界火计/义绝/蛊惑 等「展示手牌」,以及其收尾信号「展示结束」。
 *  展示走「粘性展示卡」:由 GameView 从 ingested 派生常驻显示
 ...
 *  展示结束是纯控制信号(GameView 据此收卡),无声无动画,同样不进队列。 */
const STICKY_REVEAL_TYPES = new Set(['展示', '展示结束']);
