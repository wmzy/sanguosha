// 巧变(张郃·主动技):你可以弃置一张手牌来跳过自己的一个阶段(回合开始和回合结束除外)。
...
export function createSkill(id: string, ownerId: number): Skill {
  return {
    ...
    name: '巧变',
    description:
      '弃一张手牌跳过阶段:摸牌阶段可从至多两名其他角色各获得一张手牌;出牌阶段可移动场上的一张牌',
  };
}
