...
**Spec:** `docs/architecture/引擎架构.md` §3.1 技能缺口（雷击/鬼道/化身）+ §4.2 八卦阵 var 修复 + §4.3 4 武器 stub（间接）+ §5 T-07（faceDown）+ §6 P1/P2 改进路径。
...
- [ ] 跑全量 typecheck + test
- [ ] 同步 `docs/architecture/引擎架构.md`（测试数 / 状态总览 / 已知不一致 / 改进路径）
- [ ] 提交 docs 变更
